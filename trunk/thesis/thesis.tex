...
\item Others - operators that do not belong to any of abovementioned categories or belong to more than one (like plus or minus, which can be used in both prefix and infix form) have to be treated in a separate way.
\end{itemize}
